...
function Navbar ()  {
  return <div className="navbar h-[60px] shadow-md relative z-10 ">
            <div className="wrapper pl-[20px] pr-[20px] pt-[10px] 
            pb-[10px] flex justify-between items-center mobile:pl-0 
            mobile:pr-0">
      {/* left side*/}
      ...
      {/* Search Input */}
              <div className="searchImput flex border-[2px] border-solid 
